...
var shadows = {
    ...
    active: "0px 0px 0px 1px #fbb909a1, 0px 0px 4px 8px #fbb909a19e",
    success: "0px 0px 0px 1px #31D0AA, 0px 0px 4px 4px #31D0AA",
    warning: "0px 0px 0px 1px #ED4B9E, 0px 0px 0px 4px rgba(237, 75, 158, 0.2)",
    focus: "0px 0px 0px 1px #fbb909a1, 0px 0px 0px 4px #fbb909a19e",
...
var InfoModal = function (_a) {
    var kiwiPriceUsd = _a.kiwiPriceUsd, tokenBalance = _a.tokenBalance, tokenSupply = _a.tokenSupply, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;

    return (React.createElement(Modal, { title: "Your GEN Breakdown", onDismiss: onDismiss},
        React.createElement(Flex, { mb: "32px", justifyContent: "space-between" },
            React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" }}, "Ballence:"),
            React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px"} }, tokenBalance+" GEN")),
        React.createElement(Flex, { mb: "32px", justifyContent: "space-between" },
            React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" }}, "GEN price:"),
            React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px"} }, "$"+kiwiPriceUsd)),
        React.createElement(Flex, { mb: "32px", justifyContent: "space-between" },
            React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" }}, "Total Supply"),
            React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px"} }, tokenSupply)),
        ));
};
...
var UserBlock = function (_a) {
    ...
    return (account ? (React.createElement(Button, { mx: 3, size: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(Button, { mx: 3, size: "sm", onClick: function () {
            onPresentConnectModal();
        } }, "Connect to a wallet")));
};

var CustomBlock = function (_a) {
    var kiwiPriceUsd = _a.kiwiPriceUsd, tokenBalance = _a.tokenBalance, tokenSupply = _a.tokenSupply;
    var onInfoModal = useModal(React.createElement(InfoModal, {kiwiPriceUsd, tokenBalance, tokenSupply}))[0];

    return (React.createElement(Button, { mx: 3, size: "sm", onClick: function () {
        onInfoModal();
        } }, tokenBalance+" GEN"));
};
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, tokenBalance = _a.tokenBalance, tokenSupply = _a.tokenSupply, kiwiPriceUsd = _a.kiwiPriceUsd, links = _a.links, profile = _a.profile, children = _a.children;
    var Icons = IconModule;
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(SubNavContainer, null,
                ...
                React.createElement(ConnectContainer, null,
                    // React.createElement(Text, { color: "textSubtle", mx: 1, bold: true }, "$" + (kiwiPriceUsd ? kiwiPriceUsd.toFixed(3) : 0)),
                    React.createElement(CustomBlock, {kiwiPriceUsd, tokenBalance, tokenSupply}),
...
var baseColors = {
    failure: "#dc2625",
    primary: "#fbb909a1",
    primaryBright: "#fbb909",
    primaryDark: "#fbb909a1",
    secondary: "#2a45ca",
    success: "#11b981",
    warning: "#FFB237",
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#2a4cca", background: "#10161c", backgroundDisabled: "#1f1f1f", contrast: "#FFFFFF", invertedContrast: "#1e262f", input: "#10161c", primaryDark: "#0098A1", tertiary: "#353547", text: "#e7e8ea", textDisabled: "#666171", textSubtle: "#a8a9ad", borderColor: "#262948", card: "#1e262f", gradients: {
